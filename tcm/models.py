...
class OldIdentify(models.Model):
    ...
    constitution_identify_points_qixu = models.PositiveSmallIntegerField(verbose_name='', blank=True, null=True)
    constitution_identify_points_yangxu = models.PositiveSmallIntegerField(verbose_name='', blank=True, null=True)
    constitution_identify_points_yinxu = models.PositiveSmallIntegerField(verbose_name='', blank=True, null=True)
    constitution_identify_points_tanshi = models.PositiveSmallIntegerField(verbose_name='', blank=True, null=True)
    constitution_identify_points_shire = models.PositiveSmallIntegerField(verbose_name='', blank=True, null=True)
    constitution_identify_points_xueyu = models.PositiveSmallIntegerField(verbose_name='', blank=True, null=True)
