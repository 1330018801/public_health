...
class OldIdentifyForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'q32': RadioSelect,
            'q33': RadioSelect,
            'points_qixu': TextInput(attrs={'class': 'easyui-numberbox',
                                            'data-options': 'width: 30, required: true, editable: false'}),
            'points_yangxu': TextInput(attrs={'class': 'easyui-numberbox',
                                              'data-options': 'width: 30, required: true, editable: false'}),
            'points_yinxu': TextInput(attrs={'class': 'easyui-numberbox',
                                             'data-options': 'width: 30, required: true, editable: false'}),
            'points_tanshi': TextInput(attrs={'class': 'easyui-numberbox',
                                              'data-options': 'width: 30, required: true, editable: false'}),
            'points_shire': TextInput(attrs={'class': 'easyui-numberbox',
                                             'data-options': 'width: 30, required: true, editable: false'}),
            'points_xueyu': TextInput(attrs={'class': 'easyui-numberbox',
                                             'data-options': 'width: 30, required: true, editable: false'}),
            'points_qiyu': TextInput(attrs={'class': 'easyui-numberbox',
                                            'data-options': 'width: 30, required: true, editable: false'}),
            'points_tebing': TextInput(attrs={'class': 'easyui-numberbox',
                                              'data-options': 'width: 30, required: true, editable: false'}),
            'points_pinghe': TextInput(attrs={'class': 'easyui-numberbox',
                                              'data-options': 'width: 30, required: true, editable: false'}),
            'yes_trend_qixu': RadioSelect,
            'yes_trend_yangxu': RadioSelect,
            'yes_trend_yinxu': RadioSelect,
            'yes_trend_tanshi': RadioSelect,
            'yes_trend_shire': RadioSelect,
            'yes_trend_xueyu': RadioSelect,
            'yes_trend_qiyu': RadioSelect,
            'yes_trend_tebing': RadioSelect,
            'yes_trend_pinghe': RadioSelect,
