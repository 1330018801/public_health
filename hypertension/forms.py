        ...
        widgets = {
            ...
            'symptom_extra': Textarea(attrs={'class': 'easyui-textbox',
                                             'data-options': 'multiline: true,'
                                                             'width: 150, height: 50'},),
            'sign_blood_pressure':  TextInput(attrs={'class': 'easyui-numberbox',
            ...
            'sign_heart_rhythm': TextInput(attrs={'class': 'easyui-numberbox',
                                                  'data-options': 'width: 40, required: true'},),
            'sign_extra': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'},),
            ...
            'auxiliary_examination': Textarea(attrs={'class': 'easyui-textbox',
                                                     'data-options': 'multiline:true,width: 150, height: 100'},),
            ...
            'take_medicine_1': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'}),
            ...
            'take_medicine_2': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'}),
            ...
            'take_medicine_2_time': TextInput(attrs={'class': 'easyui-numberbox',
                                                     'data-options': 'width: 30, precision: 1'}),
            'take_medicine_3': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'}),
            ...
            'take_medicine_3_time': TextInput(attrs={'class': 'easyui-numberbox',
                                                     'data-options': 'width: 30, precision: 1'}),
            'take_medicine_qt': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'}),
            ...
            'take_medicine_qt_time': TextInput(attrs={'class': 'easyui-numberbox',
                                                      'data-options': 'width: 30, precision: 1'}),
            'transfer_treatment_reason': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'}),
            'transfer_treatment_institution': TextInput(attrs={'class': 'easyui-textbox', 'data-options': 'width: 150'}),
