...
# from hypertension.preview import *
import views
...
urlpatterns = patterns('',
    url(r'^$', service_index, {'type_label': 'hypertension'}, name='index'),
    ...
    #    {'content_form': Aftercare1Form, 'type_label': 'hypertension', 'item_label': 'aftercare_1'},
    #    name='aftercare_1'),
    #url(r'^aftercare_2/$', service_disposal,
    #    {'content_form': Aftercare2Form, 'type_label': 'hypertension', 'item_label': 'aftercare_2'},
    #    name='aftercare_2'),
    #url(r'^aftercare_3/$', service_disposal,
    #    {'content_form': Aftercare3Form, 'type_label': 'hypertension', 'item_label': 'aftercare_3'},
    #    name='aftercare_3'),
    #url(r'^aftercare_4/$', service_disposal,
    #    {'content_form': Aftercare4Form, 'type_label': 'hypertension', 'item_label': 'aftercare_4'},
    #    name='aftercare_4'),
