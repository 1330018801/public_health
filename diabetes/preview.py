...
class Aftercare1FormPreview(FormPreview):
    form_template = 'diabetes/aftercare_1_form.html'
    preview_template = 'diabetes/aftercare_1_preview.html'

    def get_context(self, request, form):
        service_type = Service.objects.get(alias='diabetes')
        service_items = Service.items.filter(service_type__alias='diabetes')
        service_items_id = []
    ...
    def done(self, request, cleaned_data):
        ...
        record.service_item = Service.objects.filter(service_type__alias='diabetes')\
            .get(alias='aftercare_1')
        record.app_label = 'diabetes'
...
class Aftercare2FormPreview(FormPreview):
    form_template = 'diabetes/aftercare_2_form.html'
    preview_template = 'diabetes/aftercare_2_preview.html'

    def get_context(self, request, form):
        aftercare1 = Service.objects.filter(service_type__alias='diabetes').get(alias='aftercare_1')
...
class Aftercare3FormPreview(FormPreview):
    form_template = 'diabetes/aftercare_3_form.html'
    preview_template = 'diabetes/aftercare_3_preview.html'
    ...
    def get_context(self, request, form):
        ...
        aftercare2 = Service.objects.filter(service_type__alias='diabetes').get(alias='aftercare_2')
        resident = Resident.objects.get(id=request.session.get('resident_id'))
        try:
...
class Aftercare4FormPreview(FormPreview):
    form_template = 'diabetes/aftercare_4_form.html'
    preview_template = 'diabetes/aftercare_4_preview.html'
    ...
    def get_context(self, request, form):
        ...
        aftercare3 = Service.objects.filter(service_type__alias='diabetes').get(alias='aftercare_3')
        resident = Resident.objects.get(id=request.session.get('resident_id'))
        try:
