        ...
        widgets = {
            ...
            'symptom_extra': Textarea(attrs={'class': 'easyui-textbox',
                                             'data-options': 'multiline: true,'
                                                             'width: 128, height: 50'},),
            'sign_sbp': TextInput(attrs={'class': 'easyui-numberbox', 'data-optios': 'width: 40, required: true'}),
            ...
            'take_medicine_1_day': TextInput(attrs={'class': 'easyui-numberbox', 'data-options': 'width: 15'}),
            ...
            'take_medicine_2_day': TextInput(attrs={'class': 'easyui-numberbox', 'data-options': 'width: 15'}),
            ...
            'take_medicine_3_day': TextInput(attrs={'class': 'easyui-numberbox', 'data-options': 'width: 15'}),
