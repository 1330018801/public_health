...
class AftercareForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'sign_sbp': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width:40px'}),
            'sign_dbp': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width:40px'}),
            ...
            'life_style_guide_sport1': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width:20px'}),
            'life_style_guide_sport2': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width:30px'}),
            'life_style_guide_sport3': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width:20px'}),
            'life_style_guide_sport4': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width:30px'}),
