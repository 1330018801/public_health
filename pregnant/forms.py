...
class BloodRoutineTestForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'leukocyte': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width: 40px;'}),
            'thrombocyte': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width: 40px;'}),
            'blood_extra': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width: 40px;'}),
        }
...
class AlanineAminotransferaseForm(ModelForm):
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'sgpt': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width: 40px'}),
        }
...
class GlutamicOxalaceticTransaminaseForm(ModelForm):
    class Meta:
        ...
        fields = '__all__'
        widgets = {
            'sgot': TextInput(attrs={'class': 'easyui-textbox', 'style': 'width: 40px'}),
        }
    ...
    class Meta:
        ...
        widgets = {
            ...
            'sgot': TextInput(attrs={'class': 'easyui-numberbox',
                                     'data-options': 'width: 40, '
                                                     'required: true'}),
            'albumin': TextInput(attrs={'class': 'easyui-textbox',
                                        'data-options': 'width: 40,'
                                                        'required: true'}),
            'tbil': TextInput(attrs={'class': 'easyui-textbox',
                                     'data-options': 'width: 40,'
                                                     'required: true'}),
            'dbil': TextInput(attrs={'class': 'easyui-textbox',
                                     'data-options': 'width: 40,'
                                                     'required: true'}),
            'scr': TextInput(attrs={'class': 'easyui-textbox',
                                    'data-options': 'width: 40,'
                                                    'required: true'}),
            'bun': TextInput(attrs={'class': 'easyui-textbox',
                                    'data-options': 'width: 40,'
                                                    'required: true'}),
...
# 抽象类PhyExamAbstract对应的Form，用于检查
...
class Aftercare2Form(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        visit_date = date.today()
        initial['visit_date'] = visit_date.strftime('%Y-%m-%d')
        next_visit_date = date.today() + timedelta(days=35)
        initial['next_visit_date'] = next_visit_date.strftime('%Y-%m-%d')
        kwargs['initial'] = initial
...
class Aftercare3Form(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        initial = kwargs.get('initial', {})
        next_visit_date = date.today() + timedelta(days=49)
        initial['next_visit_date'] = next_visit_date.strftime('%Y-%m-%d')
        kwargs['initial'] = initial
...
class Aftercare5Form(ModelForm):
    ...
    def clean(self):
        cleaned_data = super(Aftercare5Form, self).clean()
        if cleaned_data.get('examination_before_parturition_fetal_heart_rate') < 90 or cleaned_data.get(
                'examination_before_parturition_fetal_heart_rate') > 200:
            msg = ""
            self.add_error('examination_before_parturition_fetal_heart_rate', msg)
...
class PostpartumVisitForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'transfer_treatment': RadioSelect,
            'guide': CheckboxSelectMultiple,
            'body_temperature': TextInput(attrs={'class': 'easyui-textbox',
                                                 'data-options': 'width: 40,'
                                                                 'required: true'}),
            'sbp': TextInput(attrs={'class': 'easyui-textbox',
                                    'data-options': 'width: 40,'
                                                    'required: true'}),
            'dbp': TextInput(attrs={'class': 'easyui-textbox',
                                    'data-options': 'width: 40,'
                                                    'required: true'}),
