...
urlpatterns = patterns('',
    ...
    url(r'^workload_doctors_page/$', views.workload_doctors_page,
        name='workload_doctors_page'),  # 获取指定乡镇卫生院下属村卫生室的工作量二维表的页面
